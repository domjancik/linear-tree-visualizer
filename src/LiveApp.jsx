...
function Sidebar({ workspace, viewer, activeView, onNavigate, onForgetToken }) {
  ...
  return <aside className="sidebar">
    ...
    <nav className="nav-main">
      <button disabled title="Not implemented"><Search size={16} /><span>Search</span><kbd>Q</kbd></button>
      <button disabled title="Not implemented"><Sparkles size={16} /><span>Ask Linear</span></button>
      <button disabled title="Not implemented"><LayoutDashboard size={16} /><span>My issues</span></button>
      <button disabled title="Not implemented"><CircleDot size={16} /><span>Inbox</span></button>
    </nav>
    <div className="nav-section">
      ...
      <button disabled title="Not implemented"><Box size={16} />Projects</button>
      <button disabled title="Not implemented"><Users size={16} />Teams</button>
    </div>
    <div className="nav-section teams">
      <div className="nav-label"><span>Live data</span></div>
      <button disabled title="Connection status"><i className="team-icon green">✓</i>Linear connected</button>
    </div>
    <div className="sidebar-bottom"><button onClick={onForgetToken}><Link2 size={16} />Forget token</button><button className="avatar" disabled title="Profile menu not implemented">{initials}</button></div>
  </aside>
}
